...
public class OrderDetail extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Orders order = Order_DAO.GetOrderByID(orderID);
            ArrayList<OrderDetails> lstdetail = OrderDetail_DAO.getOrderDetailByOrderID(orderID);
            session.setAttribute("order", order);
            session.setAttribute("lstdetail", lstdetail);
